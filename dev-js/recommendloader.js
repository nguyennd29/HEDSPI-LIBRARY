$(document).ready(function() {
    ...
    $.ajax({
        url: 'https://lib-server.azurewebsites.net/api/recommend'||'http://localhost:6969/api/recommend',
        ...
        success: function (data) {
            if (data.book[0]) {
                ...
                $('.recommendDetail1').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[0].bookid}`;
                });
            ...
            if (data.book[1]) {
                ...
                $('.recommendDetail2').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[1].bookid}`;
                });
            ...
            if (data.book[2]) {
                ...
                $('.recommendDetail3').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[2].bookid}`;
                });
            ...
            if (data.book[3]) {
                ...
                $('.recommendDetail4').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[3].bookid}`;
                });
            ...
            if (data.book[4]) {
                ...
                $('.recommendDetail5').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[4].bookid}`;
                });
            ...
            if (data.book[5]) {
                ...
                $('.recommendDetail6').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[5].bookid}`;
                });
            ...
            if (data.book[6]) {
                ...
                $('.recommendDetail7').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[6].bookid}`;
                });
            ...
            if (data.book[7]) {
                ...
                $('.recommendDetail8').click(function () {
                    window.location.href = `/bookdetail?id=${data.book[7].bookid}`;
                });
