...
$(document).ready(function() {
    ...
    if((/id=([^&]+)/.exec(url))) {
        ...
        $.ajax({
            url: `http://localhost:6969/api/bookdetail/info/${bookid}`,
            method: 'GET',
            success: function (data) {
               console.log(data);
                ...
                $.ajax({
                    url: `http://localhost:6969/api/search/tag/${data.book[0].tag}`,
                    ...
                    success: function (data2) {
                        if (data2.book[0]) {
                            ...
                            $('.recommendDetail1').click(function () {
                                window.location.href = `/bookdetail?id=${data2.book[0].bookid}`;
                            });
                        ...
                        if (data2.book[1]) {
                            ...
                            $('.recommendDetail2').click(function () {
                                window.location.href = `/bookdetail?id=${data2.book[1].bookid}`;
                            });
                        ...
                        if (data2.book[2]) {
                            ...
                            $('.recommendDetail3').click(function () {
                                window.location.href = `/bookdetail?id=${data2.book[2].bookid}`;
                            });
                        ...
                        if (data2.book[3]) {
                            ...
                            $('.recommendDetail4').click(function () {
                                window.location.href = `/bookdetail?id=${data2.book[3].bookid}`;
                            });
                        ...
                        if (data2.book[4]) {
                            ...
                            $('.recommendDetail5').click(function () {
                                window.location.href = `/bookdetail?id=${data2.book[4].bookid}`;
                            });
        ...
        $.ajax({
            url: `http://localhost:6969/api/bookdetail/comment/${bookid}`,
            method: 'GET',
            success: function (data) {
                $('#commentlist').html('');
